...
<body>
<form action="payinsert.php" method="POST" id="payment-form" class="form-horizontal">
...
?>
  ...
  <fieldset>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <input type="text" name="cardnumbe" id="cardnumberr" maxlength="19" placeholder="Card Number" class="card-number form-control">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <div class="form-inline">
          <input type="date" name="select2" id="date">
          <span> / </span>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-3">
        <input type="text" id="cv" placeholder="CVV" maxlength="4" class="card-cvc form-control">
        <br>
