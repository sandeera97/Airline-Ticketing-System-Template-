<?php
	...
	$sql = "INSERT INTO one (Depature,Arrival,Departs,Returns,class) VALUES('$Depature','$Arrival','$Departs','$Class')";
	...
	else
	{
	    ...
	    $con = mysqli_connect('localhost','root','','projectfinal');
			$sql=mysqli_query($con,"select * from onewayy where Flyone='$Depature' and Flytwo='$Arrival' and Ddate='$Departs' and class='$Class'" );
			echo"<select>";
			...
			echo"<tr height='50'>";
					...
					echo"</td>";
					echo"<td width='200'>";
								header("Location:logaf.php?id=".$fname.$fly1.$fly2.$price.$dd.$Class);
					echo"</td>";
			echo"</tr>";
		echo"</table>";
