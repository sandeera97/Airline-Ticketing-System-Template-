...
<body background="new images/26.jpg" marginheight="30" marginwidth="200">
	
 
  <span onclick="document.getElementById('id01').style.display='none'" class="close" title="Close Modal">&times;</span>
  <form class="modal-content" action="insertAcc.php" method="post">
    <div class="container">
      <h1>Sign Up</h1>
      ...
      <p>If you have Already Account <a href="login.php" style="color:dodgerblue">Click</a>.</p>
