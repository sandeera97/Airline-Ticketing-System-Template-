      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="class.php"><span class="glyphicon glyphicon-log-in"></span> Business </a></li>
        	<li><a href="economy.php"><span class="glyphicon glyphicon-user"></span> Economy </a></li>
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        ...
        <div class="carousel-caption">
          <h3>Welcome Sri Lanka</h3>
          <p>The atmosphere in New York is lorem ipsum.</p>
        </div>      
      </div>
      
      <div class="item">
        <img src="new images/shhit.png" alt="Chicago" width="1200" height="700">
        <div class="carousel-caption">
          <h3>Welcome Sri Lanka</h3>
      ...
      <div class="item">
        <img src="new images/rt_1920x700.png" alt="Los Angeles" width="1200" height="700">
        <div class="carousel-caption">
          <h3>Welcome Sri Lanka</h3>
      ...
      <div class="item">
        <img src="new images/ewq_1920x700.png" alt="Los Angeles" width="1200" height="700">
        <div class="carousel-caption">
          <h3>Welcome Sri Lanka</h3>
          <p>Even though the traffic was a mess, we had the best time playing at Venice Beach!</p>
        </div>      
      ...
      <div class="item">
        <img src="new images/qwe_1920x700.png" alt="Los Angeles" width="1200" height="700">
        <div class="carousel-caption">
          <h3>Welcome Sri Lanka</h3>
          <p>Even though the traffic was a mess, we had the best time playing at Venice Beach!</p>
        </div>      
...
<table align="center" border="0" background="new images/1-1278141033-bg-blue-white-gradient-980x445.jpeg" width="100%" height="400">
 ...
 <form action="insert.php" method="post">
	...
	<table border="0" align="center">
		...
		<tr height="50">
			<td width="200">
				<center><font face="calibri" size="+1" color="#FFFFFF">Class</center></font>
			</td>
			<td width="200">
				<center><input type="text" name="class" id="class" required=""></center>
			</td>
		</tr>
	</table>
		<script>
...
<td width="50%">
		...
		<form action="ava3insert.php" method="post">
	...
	<table bgcolor="#0084FF" border="0" align="center">
		...
		<tr height="50">	
			...
			<script>
			var today = new Date().toISOString().split('T')[0];
    document.getElementsByName("donn")[0].setAttribute('min', today);
		</script>
		</tr>
	</table>
...
<table align = "center" border = "0">
		<tr height = "10">
			...
			<td width = "200">
				...
				<img src="pics/images.png" width="70" height="70">
...
<div id="contact" class="container">
  <h2 class="text-center">Contact & Comments</h2>
  ...
  <div class="row">
    ...
    <div class="col-md-8">
      ...
      <div class="row">
        ...
        <div class="col-md-12 form-group">
          <a href="#">
          <font face="arial" size="+1" color="#FF0004"> If You want Cancel Ticket Please </font>
          <input type="button" value="Contact Us" id="bt1">
          </a>
        </div>
      </div>
    </div>
