        ...
        <div class="col-xs-12 col-md-4 col-md-offset-4">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" action="payin.php" method="post">
                       <div class="row">
                            <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" required name="nic" class="form-control" placeholder="NIC NUMBER" />
                                        <span class="input-group-addon"><span class="fa fa-credit-card"></span></span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" required name="card" class="form-control" placeholder="Valid Card Number" />
                                        <span class="input-group-addon"><span class="fa fa-credit-card"></span></span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xs-7 col-md-7">
                                <div class="form-group">
                                    ...
                                    <input type="date" required name="edate" class="form-control" placeholder="MM / YY" />
                                </div>
                            </div>
                            <div class="col-xs-5 col-md-5 pull-right">
                                <div class="form-group">
                                    <label>CV CODE</label>
                                    <input type="text" required name="cv" class="form-control" placeholder="CVC" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" required name="cname" class="form-control" placeholder="Card Owner Names" />
